...
public class DeploymentRoutingFunction {
	...
	private static String createDepCategory(ApiClient apiClient, String serviceId, DeploymentRoutingInput input) {
		...
		if (category == null) {
			result = ViewUtil.createCategory(input.category, serviceId, apiClient, SHARED);
	...
	//A sample program on how to programmatically activate DeploymentRoutingFunction
