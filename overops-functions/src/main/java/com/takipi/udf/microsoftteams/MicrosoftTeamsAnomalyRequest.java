...
public class MicrosoftTeamsAnomalyRequest implements ApiPostRequest<EmptyResult> {
    ...
    public MicrosoftTeamsAnomalyRequest(String url, String viewErrorsLink,
                                        ...
                                        String totalEventsOccurred, String timeSlot,
                                        String environmentsName, String reportedByName,
    ...
    public String postData() {
        MicrosoftCard microsoftCard = MicrosoftCard.newBuilder()
                .setThemeColor("c80000")
                .setText(getTopText())
                .addSections(getSummarySection())
                .addSections(eventSections)
                .build();
    ...
    private MicrosoftActivitySection getSummarySection() {
        return MicrosoftActivitySection.newBuilder()
                .setActivityImage(SUMMARY_IMAGE)
                .setActivityTitle(new MicrosoftTextBuilder()
                        .addBoldLink(viewErrorsLink, "View errors")
                        .build())
                .setActivitySubtitle(new MicrosoftTextBuilder()
                        .addLink(manageSettingsLink, "Manage settings")
                        .build())
                .addFacts(new MicrosoftFact("View", viewName),
                        new MicrosoftFact("Threshold", thresholdCount),
                        new MicrosoftFact("Between", timeSlot),
                        new MicrosoftFact("Times", totalEventsOccurred))
                .build();
    }

    private String getTopText() {
        return new MicrosoftTextBuilder()
    ...
    public static class Builder {
        ...
        public MicrosoftTeamsAnomalyRequest build() {
            return new MicrosoftTeamsAnomalyRequest(url, viewErrorsLink,
                    viewName, thresholdCount,
                    totalEventsOccurred, timeSlot,
                    environmentsName, reportedByName,
                    manageSettingsLink, eventSections);
        }
