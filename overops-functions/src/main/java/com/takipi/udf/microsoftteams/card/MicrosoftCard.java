...
public class MicrosoftCard {
	...
	public MicrosoftCard(String type, String context, String themeColor, String summary, String text,
			List<MicrosoftSection> sections, List<MicrosoftPotentialAction> potentialAction) {
		this.type = type;
